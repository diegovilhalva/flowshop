...
export default function CreateProductReviewDialog({
  ...
  async function onSubmit({ title, body, rating }: FormValues) {
    if (!product._id) {
      throw Error("ID do produto está ausente");
    }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Gostou deste produto? Compartilhe sua opinião com outros clientes.
          </DialogDescription>
        </DialogHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormMessage />
                    <FormDescription>
                      Escreva uma avaliação detalhada para ajudar outros clientes.
                    </FormDescription>
                  </FormItem>
                )}
              />
