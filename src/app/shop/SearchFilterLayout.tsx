...
export default function SearchFilterLayout({ children, collections }: SearchFilterLayoutProps) {
...
function PriceFilter({
    ...
    return (
        <div className="space-y-3">
            <div className="font-bold">Faixa de preço</div>
...
function SortFilter({ sort, updateSort }: SortFilterProps) {
    return (
        <Select value={sort || "last_updated"} onValueChange={updateSort}>
            ...
            <SelectContent>
                <SelectItem value="last_updated">Mais recentes</SelectItem>
